...
class Tool(abc.ABC):
    ...
    def schema(self)->dict[str,Any] | type['BaseModel']:
        raise NotImplemented("Tool Must define schema property or class attribute")
    
    @abc.abstractmethod
    async def execute(self,invocation:ToolInvocation)->ToolResult:
        pass

    def vaildate_params(self,params:dict[str,Any])->list[str]:
        schema = self.schema
    ...
    async def get_confirmation(self,invocation:ToolInvocation)->ToolInvocation|None:
        ...
        return ToolConfirmation(
            ...
            description=f"Excite {self.name}",
        )
