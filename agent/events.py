...
class AgentEvent:
    ...
    @classmethod
    def agent_end(cls, response:str|None, usage:TokenUsage |None=None)->AgentEvent:
        return cls(
    ...
    @classmethod
    def text_delta(cls, context:str)->AgentEvent:
        return cls(
    ...
    @classmethod
    def text_complete(cls, context:str)->AgentEvent:
        return cls(
